...
纯终端运行的狼人杀、杀人游戏与捉鬼猜词框架。真人、OpenAI-compatible LLM 和离线本地机器人可以混坐；法官、行动合法性、消息权限、死亡结算与胜负判断全部由 Python 程序确定性执行，不依赖 LLM。
...
- 公开、单人私密、狼人/杀手频道、警察频道、无词幽灵名单与恋人频道在进入控制器前完成权限裁剪。
...
| `ghost_blank`        | 6–16 人；互认幽灵随人数扩展且无词可猜，其余水民拿公共词      |
...
杀人游戏中，警民抓完杀手获胜，杀手屠光警察或平民任一边获胜。两种捉鬼都没有夜晚：近义词版幽灵拿到另一张相关词牌且互不相认；无词版幽灵开局互认但没有词，被投出时各有一次猜水民词牌的机会，猜中立即翻盘。幽灵存活到只剩一名水民也会获胜。三种模式的玩法与人数独立选择；默认牌组在 6–11 人使用 2 名敌对角色，12–15 人使用 3 名，16 人使用 4 名，杀人游戏配置同等数量的警察。
